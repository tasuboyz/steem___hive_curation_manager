...
async def calculate_vote_value(vote_percent, effective_vests=None, voting_power=9200):
...
def get_post_voters(self, post_url, min_importance=0.0):
        ...
        try:
            ...
            platform, blockchain_instance = blockchain_connector.get_platform_and_instance(post_url)
